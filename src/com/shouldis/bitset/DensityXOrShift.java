...
/**
 * Implementation of {@link XOrShift} which generates bits with a specified
 ...
 * methods retain the behavior of {@link XOrShift}.
 * <p>
 ...
 * @see XOrShift
 */
public class DensityXOrShift extends XOrShift {
	 ...
	 * will have on average ({@link #density} * {@link Integer#SIZE}) bits in the
	 * <i>live</i> state, and longs will have ({@link #density} * {@link Long#SIZE})
	 * bits in the <i>live</i> state, with each generated bit having a chance equal
	 * to {@link #density} to be in the <i>live</i> state.
	 */
	...
	/**
	 * Generates a {@link DensityXOrShift} with the specified <b>density</b>,
	...
	/**
	 * Generates a {@link DensityXOrShift} with the specified <b>density</b> and
	 ...
	 * between a {@link DensityXOrShift}'s {@link #density}, and the value it is
	 * estimated to.
	 * 

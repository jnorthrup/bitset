...
import com.shouldis.bitset.random.DensityRandom;
...
public class BitSet {
	 ...
	 * the density of the {@link Random} <b>random</b>. In contrast to
	 * {@link #xOrRandomize(Random)} and {@link #xOrRandomize(Random, int, int)},
	 * this method preserves that density. When using a uniformly distributed
	 * {@link Random} (as opposed to {@link DensityRandom}), this is unnecessary. No
	 * action is taken if <b>from</b> is greater than or equal to <b>to</b>.
	 * 
	 * @param random the instance of {@link Random} used to randomize.
	 ...
	 * @see DensityRandom
	 */
	public final void randomize(final Random random, final int from, final int to) {
		if (from >= to) {
			return;
		}
		final int start = divideSize(from);
	 ...
	 * {@link Random} <b>random</b>. In contrast to {@link #xOrRandomize(Random)}
	 * and {@link #xOrRandomize(Random, int, int)}, this method preserves that
	 ...
	 * @see DensityRandom
	 */
	public final void randomize(final Random random) {
	 ...
	 * random bits generated by the specified {@link Random} <b>random</b>. When
	 * using a non-uniformly distributed {@link Random}, namely
	 * {@link DensityRandom}, the resulting density of this {@link BitSet} can be
	 ...
	 * @see DensityRandom
	 */
	public final void xOrRandomize(final Random random, final int from, final int to) {
		if (from >= to) {
			return;
		}
		final int start = divideSize(from);
	 ...
	 * by the specified {@link Random} <b>random</b>. When using a non-uniformly
